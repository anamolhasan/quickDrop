...
import useTrackingLogger from "../components/useTrackingLogger";
  ...
  const onSubmit = (data) => {
    ...
    `,
      ...
      if (result.isConfirmed) {
        ...
        // -------------------------------
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}/parcels`, parcelData).then(async (res) => {
          ...
          if (res.data.insertedId) {
            ...
            await logTracking({
              ...
              details: `Created by ${session?.user?.displayName}`,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="border p-4 rounded-xl shadow-md space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              />
              <select
                {...register("sender_region", { require: true })}
