...
//       try {
//         const base64Image = reader.result.split(",")[1]; // get base64 only
...
//               {...register("name", { required: true })}
//               placeholder="Enter your name"
//               className="w-full py-3 bg-gray-100 focus:outline-none"
//               disabled={loading}
//             />
//           </div>
//           {errors.name && (
...
//             onClick={() => signIn("google")}
//             disabled={loading}
//             className="flex items-center justify-center gap-2 w-full md:w-1/2 mx-auto bg-white border rounded-xl px-4 py-2 shadow-sm hover:shadow-md disabled:opacity-50"
//           >
//             <FcGoogle className="text-xl" />
//             <span>Continue with Google</span>
//           </button>
...
//             onClick={() => signIn("github")}
//             disabled={loading}
//             className="flex items-center justify-center gap-2 w-full md:w-1/2 mx-auto bg-gray-900 text-white rounded-xl px-4 py-2 shadow-sm hover:bg-gray-800 disabled:opacity-50"
//           >
//             <FaGithub className="text-xl" />
//             <span>Continue with GitHub</span>
//           </button>
