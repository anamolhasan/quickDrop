...
import { useRouter } from "next/navigation";
import Link from "next/link";
import { Bike, Sparkles, Zap, Shield } from "lucide-react";
...
export default function LoginPage() {
  ...
  // ✅ NextAuth দিয়ে Social Login (Best Practice)
  const handleSocialLogin = (provider) => {
    signIn(provider, {
      callbackUrl: "/" // Successful হলে homepage এ redirect হবে
    });
  };
