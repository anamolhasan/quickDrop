...
const BangladeshMap = ({ serviceCenters }) => {
  ...
  return (
    <div className="h-[500px] w-full rounded-lg overflow-hidden shadow-lg relative z-1">
      <form
        onSubmit={handleSearch}
        className="absolute top-4 left-1/2 transform -translate-x-1/2 z-40 w-full max-w-md  flex bg-gray-400 "
      >
        <input
          type="text"
